...
import com.szip.sleepee.View.character.CharacterPickerView;
import com.szip.sleepee.View.character.OnOptionChangedListener;
...
public class CharacterPickerWindow extends PopupWindow implements View.OnClickListener {
    ...
    public void setPickerWithoutLink(List<String> options1Items,
        ...
        pickerView.setPickerWithoutLink(options1Items,options2Items,options3Items);
    }
