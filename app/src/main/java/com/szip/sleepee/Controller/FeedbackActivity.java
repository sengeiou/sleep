...
import static com.szip.sleepee.Util.HttpMessgeUtil.FEEDBACK_FLAG;
            ...
            public void onClick(View v) {
                if (feedbackEt.getText().toString().length()>120)
                    ...
                    try {
                        ...
                        HttpMessgeUtil.getInstance(FeedbackActivity.this).postSendFeedback(feedbackEt.getText().toString(), FEEDBACK_FLAG);
                    } catch (IOException e) {
                        e.printStackTrace();
                    }
            }
