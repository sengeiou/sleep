 ...
 */
package com.szip.smartdream.View.wheelview.adapters;
		...
		if (index >= 0 && index < getItemsCount()) {
			...
			if (textView != null) {
				...
				if (index == currentIndex) {
					textView.setTextSize(TypedValue.COMPLEX_UNIT_DIP, maxsize);
				} else {
					textView.setTextSize(TypedValue.COMPLEX_UNIT_DIP, minsize);
				}
