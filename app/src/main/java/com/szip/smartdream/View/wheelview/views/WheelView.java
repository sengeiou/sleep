...
package com.szip.smartdream.View.wheelview.views;
...
import com.szip.smartdream.View.wheelview.adapters.WheelViewAdapter;
...
public class WheelView extends View {
	...
	private static final int[] SHADOWS_COLORSS = new int[] { 0x00000000, 0x00000000, 0x00000000 };
	...
	private void initResourcesIfNecessary() {
		...
		if (topShadow == null) {
			if(!isTransparent){
				...
				topShadow = new GradientDrawable(Orientation.TOP_BOTTOM, SHADOWS_COLORSS);
			}
		}
		...
		if (bottomShadow == null) {
			if(!isTransparent){
				...
				bottomShadow = new GradientDrawable(Orientation.BOTTOM_TOP, SHADOWS_COLORSS);
			}
			//bottomShadow = new GradientDrawable(Orientation.BOTTOM_TOP, SHADOWS_COLORS);
		}
